 ...
 * Header title.
 */
// define ('PDF_HEADER_TITLE', 'PT. Hydromart Utama Indonesia');
define ('PDF_HEADER_TITLE', '');

/**
 * Header description string.
 */
// define ('PDF_HEADER_STRING', "Sedayu Square Blok H-03\nJl. Outer Ring Road Lingkar Luar Cengkareng Barat\nRT. 1 , RW. 12 Jakarta Barat 11730\nsales@hydromart.co.id\n021-8062-7055");
